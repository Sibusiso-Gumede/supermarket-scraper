...
async def screenshot_images(page):
    ...
    count = 1
    type = "jpeg"
    path = r"C:/Users/Acer/Documents/dev_env/discount_my_groceries/website_api's/product_images/spar_products"
    quality = 100
